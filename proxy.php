...
if (json_last_error() === JSON_ERROR_NONE) {
  ...
  //request validation
  if (!isset($method) || empty($is_json_string_request->method)) {
...
switch ($method) {
  case "POST":
    ...
    */
    ...
    // $post_parameters = http_build_query(['email'=>$email, 'coupone_code'=>$coupone_code]);
    $post_parameters = json_encode($data);
